...
#sw
listes=pd.read_excel("ilker/turkish-stopwords.xlsx") #kendi oluştuduğum stopwordsu okutuyorum.
...
import os
os.system('cmd /c "pip install tweet-capture"')
os.system('cmd /c "tweetcapture"')
df['Url'][1]

import tweet-capture
tweetcapture "https://twitter.com/Sude_zeybek_/status/1607888620286889984"